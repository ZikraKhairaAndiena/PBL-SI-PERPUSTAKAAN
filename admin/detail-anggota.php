<?php
    ...
    if (isset($_GET['id_anggota'])) {
      ...
      $query = $db->query("SELECT * FROM data_anggota WHERE id_anggota='$id_anggota'");
      ...
      if ($query) {
          if ($query->num_rows == 1) {
              ...
              echo "Data dengan Id Anggota '$issn' tidak ditemukan.";
          }
      } else {
          echo "Error dalam menjalankan query: " . $db->error;
      }
  } else {
      echo "Parameter ID Anggota tidak ditemukan dalam URL.";
  }
          ...
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                      <div class="col-md-6">
                        <p class="card-title mb-0">Detail Anggota</p>
                      </div>
                    <br>
                    ...
                    <tr>
                    <td width="250">ID Anggota</td>
                    <td width="550"><?php echo isset($data['id_anggota']) ? $data['id_anggota'] : ''; ?></td>
                    </tr>
                    </tr>
                    <tr>
