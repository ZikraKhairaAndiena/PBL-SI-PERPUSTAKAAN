<?php
    ...
    if (isset($_GET['user_id'])) {
        ...
        if ($result->num_rows == 1) {
            ...
            echo "Data User ID " .$user_id. " tidak ditemukan";
        }
        ...
        if (isset($_POST['update'])) {
            ...
            $query = "UPDATE admin SET username='$username', password='$password', nama1='$nama1', level='$level' WHERE user_id='$user_id' ";
                ...
                <h4 class="card-title">Edit Data Pengguna</h4>
                  <form class="forms-sample" method="post">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="user_id" name="user_id" placeholder="User_id"  value="<?=$user_id?>" readonly>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="nama1" name="nama1"  placeholder="Nama1"  value="<?=$nama1?>">
                    </div>
                    <div class="form-group">
