            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-6">
                      <p class="card-title mb-0">Data Pengembalian</p>
                    </div>
                    <?php
                          if ($_SESSION['level']=='pustakawan') {          
                        ?>
                    <div class="col-md-6 text-md-right">
                      <a href="peminjaman.php" class="btn btn-success">Data Peminjaman</a>
                      <a href="cetak-pengembalian.php" class="btn btn-danger">Cetak</a>
                    </div>
                    <?php
                          }
                    ?>
                    ...
                    <div class="col-12">
                      ...
                      <?php
                        ...
                        <table id="example" class="display expandable-table" style="width:100%">
                          ...
                          <tbody>
                            <?php
                                $query = $query = "SELECT * FROM trans_pinjam WHERE status='kembali' ORDER BY id";;
                                $result = $db->query($query); 
                                $nomor = 1;
                            ...
                            <tr>
                                ...
                                <td><font color="blue"><?=$row['status']?></td>
                                <td>
                            </tr>
                        <?php endforeach ?>
                        </tbody>
                      </table>
                      <?php $tampil = $db->query("SELECT * FROM trans_pinjam WHERE status='kembali' ORDER BY id");
                        $pinjam = $tampil->num_rows;
                        ?>
                        <br><center><h5>Jumlah Pengembalian : <?php echo "$pinjam"; ?> Orang </h5> </center>
                      </div>
                    </div>
                  </div>
                  </div>
