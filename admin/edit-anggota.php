<?php
    ...
    if (isset($_GET['id_anggota'])) {
        ...
        if ($result->num_rows == 1) {
            ...
            echo "Data ID " .$id_anggota. " tidak ditemukan";
        }
        ...
        if (isset($_POST['update'])) {
            ...
            $query = "UPDATE data_anggota SET nama='$nama', gender='$gender', jurusan='$jurusan', prodi='$prodi', status='$status', email='$email', notelp='$notelp' WHERE id_anggota='$id_anggota' ";
    
            //cek apakah update sukses atau gagal
            if ($db->query($query) == TRUE) {
                header("Location: data-anggota.php");
            }else {
                echo "Data gagal di Update ".$db->error;
            };
        }
                ...
                <h4 class="card-title">Edit Data Anggota</h4>
                  <form class="forms-sample" method="post">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="id_anggota" name="id_anggota" placeholder="ID Anggota"  value="<?=$id_anggota?>" readonly>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="notelp" name="notelp"  placeholder="No Telepon" value="<?=$notelp?>" required>
                    </div>
                    <button type="submit" class="btn btn-primary mr-2" name="update" value="Update">Update</button>
