        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                <h4 class="card-title">Tambahkan Data Pengarang</h4>
                  <form action="insert-pengarang.php" class="forms-sample" method="post">
            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                      <div class="col-md-6">
                        <p class="card-title">Data Pengarang</p>
                      </div>
                  <div class="row">
                    <div class="col-12">
                        ...
                        <table id="example" class="display expandable-table" style="width:100%">
                          ...
                          <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="edit-pengarang.php?id=<?=$row['id']?>" class="btn btn-warning">Edit</a> |
                                    <a onclick="return confirm('Apakah anda yakin menghapus data?')" href="delete-pengarang.php?id=<?php echo $row['id']; ?>" class="btn btn-danger">Delete</a>
                                </td>
                            </tr>
                        <?php endforeach ?>
                        </tbody>
